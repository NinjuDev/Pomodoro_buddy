...
async def help_command(ctx):
    ...
    embed.set_image(url='https://media.discordapp.net/attachments/1118491800949243946/1201029771832856688/image-dZSV0zCjO-transformed.png')
...
bot.run(
    'MTIwMDEwMzI0MzQ0ODA2NjA1OQ.GT039Z.YLJ8bi8M12IrMmj15AQkvKoi9PuggzmtS_WRFU')
